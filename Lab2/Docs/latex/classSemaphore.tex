...
\begin{DoxyCode}
31 \{
32       std::unique\_lock< std::mutex > lock(m\_mutex);
33       ++m\_uiCount;
34       m\_condition.notify\_one();
35 \}
\end{DoxyCode}
...
23       \textcolor{keywordflow}{if} (!m\_condition.wait\_for(lock,crRelTime,[&]()->bool\{ return m\_uiCount>0; \}))\{
